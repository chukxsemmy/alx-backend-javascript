...
console.log(createEmployee('Ada', 'Ameh', 200));
console.log(createEmployee('Bisi', 'Tunde', 1000));
console.log(createEmployee('Oge', 'Okoye', '$500'));
...
console.log(executeWork(createEmployee('Ada', 'Ameh', 200)));
console.log(executeWork(createEmployee('Bisi', 'Tunde', 1000)));
